...
<div class="panel panel-bordered">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 form-inline">
        <form method="GET" action="{{ route('ingreso.show', $registros->id) }}" class="form-inline" >
            {{ csrf_field() }}
          ...
          <a href="{{route('ingreso.show', [$id, 'descargar_pdf'=>1])}}" title="Imprimir" class="btn btn-sm btn-primary edit" target="_blanck" style="margin-left:20px;">
    ...
    <div class="table-responsive">
        ...
        <div class="panel panel-primary">
            ...
            <div class="row datososc">
                ...
                <div class="col-sm-2">
                    <strong>Nombre del Colaborador:</strong><br/> {{ $registros->user->name }} {{ $registros->user->apellido }}
                </div>
                <div class="col-sm-2">
                    <strong>Nombre del Jefe inmediato:</strong><br/>  
